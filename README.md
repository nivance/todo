...
* Java
  ...
  + [bytejta](https://github.com/liuyangming/bytejta): ByteJTA是一个兼容JTA规范的基于XA/2PC的分布式事务管理器
  + [meepo](https://github.com/wxbty/meepo): 基于ByteJta，仿GTS实现的分布式事务框架
  ...
  + [id-generator](https://github.com/jingpeicomp/id-generator)
  + [qmq](https://github.com/qunarcorp/qmq)：QMQ是去哪儿网内部广泛使用的消息中间件
  * [Serial](https://github.com/twitter/Serial)：Light-weight, fast framework for object serialization in Java, with Android support.
  * [microbenchmark-runner](https://github.com/mp911de/microbenchmark-runner)
  * [mdrill](https://github.com/alibaba/mdrill)：for千亿数据即席分析
  * [flower](https://github.com/zhihuili/flower)：流式微服务框架Flower
...
* Python
  ...
  + [QASystemOnMedicalKG](https://github.com/liuhuanyong/QASystemOnMedicalKG): 知识图谱构建，自动问答，基于kg的自动问答
  + [ShortURL](https://github.com/mozillazg/ShortURL)：A URL Shortener Site 短网址生成网站
  + [Chinese_poem_generator](https://github.com/hjptriplebee/Chinese_poem_generator)：唐诗、宋词生成器
...
* [How-To-Ask-Questions-The-Smart-Way](https://github.com/tvvocold/How-To-Ask-Questions-The-Smart-Way): 《提问的智慧》中文版
